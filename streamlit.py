...
def detect_objects(our_image):
    ...
    # YOLO ALGORITHM
    net = cv2.dnn.readNet("yolov4-custom_best.weights", "yolov4_testing.cfg")
    ...
    for i in range(len(boxes)):
        if i in indexes:
            ...
            cv2.putText(img, text, (x, y - 5), cv2.FONT_HERSHEY_SIMPLEX,5.0, color, 5)
...
def object_main():
    ...
    if choice == "Browse an Image":
        ...
        our_image = Image.open("images/Media1.jpg")
        detect_objects(our_image)
